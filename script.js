...
function validateColors() {
  ...
  function getMaskPath(id, shape, hairStyle, eyeStyle) {
    const masks = {
      "base-color-layer": `recursos/Bases/${shape}/color.png`, // Usa la forma seleccionada
      "hair-color-layer": `recursos/cabello/${hairStyle}/color.png`, // Usa el estilo de cabello seleccionado
      "eye-color-layer": `recursos/ojos/${eyeStyle}/color.png` // Usa el estilo de ojos seleccionado
    };
    return masks[id];
  }
